...
export default function DailyTasksView() {
  ...
  useEffect(() => {
    ...
    const dummyTasks: Task[] = [
      {
        id: "t1",
        title: "কোয়ার্টারলি রেভিনিউ গোল রিভিউ (Q3)",
        description: "Q3 এর রেভিনিউ টার্গেট অনুযায়ী আমাদের এচিভমেন্ট বিশ্লেষণ করতে হবে এবং Q4 এর জন্য নতুন টার্গেট সেট করতে হবে। হাই-টিকেট ক্লায়েন্টদের উপর ফোকাস বাড়াতে হবে।",
        status: "pending",
        priority: "urgent",
      ...
      {
        id: "t2",
        title: "নতুন অটোমেশন সার্ভিসের প্রাইসিং ফাইনাল করা",
        description: "আমাদের নতুন AI এবং চ্যাটবট অটোমেশন সার্ভিসের প্যাকেজ এবং প্রাইসিং ঠিক করতে হবে। কালকের মিটিংয়ের আগে এটা রেডি থাকা চাই।",
        status: "pending",
        priority: "high",
        createdAt: new Date().toISOString(),
        dueDate: new Date().toISOString().split('T')[0]
      ...
      {
        id: "t3",
        title: "এমপ্লয়ি পারফরম্যান্স রিভিউ ও বোনাস ঠিক করা",
        description: "টিম লিডদের রিপোর্টগুলো দেখে এই মাসের পারফরম্যান্স বোনাস ফাইনাল করতে হবে।",
        status: "in_progress",
        priority: "high",
      ...
      {
        id: "t4",
        title: "এজেন্সি ইনভেস্টমেন্ট এবং গ্রোথ মিটিং",
        description: "মার্কেটিং বাজেট এবং নতুন টুলস সাবস্ক্রিপশন নিয়ে ইনভেস্টমেন্ট প্ল্যান ঠিক করতে হবে।",
        status: "pending",
        priority: "medium",
        createdAt: new Date().toISOString(),
      ...
      {
        id: "t5",
        title: "ভিআইপি ক্লায়েন্ট প্রোফাইল অডিট",
        description: "যেসব ক্লায়েন্ট মান্থলি ৫ লক্ষের উপর বাজেট দেয় তাদের বর্তমান প্রজেক্ট স্ট্যাটাস চেক করা।",
        status: "completed",
        priority: "medium",
    ...
    setTasks(dummyTasks);
    localStorage.setItem('superAdminTasks', JSON.stringify(dummyTasks));
  }, []);
